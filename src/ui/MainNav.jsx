    ...
    <nav className="w-full" >
       <ul className=" w-full " >
        ...
        <li className="p-5 w-full">
          <NavLink
            to='/guest'
            className={({isActive})=> `flex gap-3 py-5 px-3 items-center font-bold ${isActive? "bg-stone-200 dark:bg-gray-600 dark:text-gray-200 dark-border-700":"" } ` }
          >
            <AiOutlineUserAdd className={({isActive})=> `${isActive? "active:text-blue-700":"group-active:text-blue-800"}`} />
            <span>Guest</span>
          </NavLink>
        </li>
        <li className="p-5">
